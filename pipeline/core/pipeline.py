...
from .config import PipelineConfig, StageConfig, OpenAIConfig, LoggingConfig
from .models import CompanyData, ProcessingResult
from ..stages.stage_1 import Stage1Processor
from ..utils.exceptions import PipelineError, ConfigurationError, FileOperationError
...
class JobPipeline:
    ...
    def from_config_file(cls, config_path: Path) -> "JobPipeline":
        ...
        try:
            ...
            raise FileOperationError("read", str(config_path), "Configuration file not found")
    ...
    def load_companies_from_file(self, companies_file: Path) -> List[CompanyData]:
        ...
        try:
            ...
            raise FileOperationError("read", str(companies_file), "Companies file not found")
        except json.JSONDecodeError as e:
