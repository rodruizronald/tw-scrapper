...
class PipelineError(Exception):
    ...
    def __init__(self, message: str, company_name: Optional[str] = None):
...
class CompanyProcessingError(PipelineError):
    ...
    def __init__(self, company_name: str, original_error: Exception, stage: str = "unknown"):
...
class HTMLExtractionError(PipelineError):
    ...
    def __init__(self, url: str, message: str, company_name: Optional[str] = None):
        self.url = url
...
class OpenAIProcessingError(PipelineError):
    ...
    def __init__(self, message: str, company_name: Optional[str] = None, response_text: Optional[str] = None):
...
class FileOperationError(PipelineError):
    ...
    def __init__(self, operation: str, file_path: str, message: str, company_name: Optional[str] = None):
