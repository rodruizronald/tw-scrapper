...
from pipeline.persistence.base import BaseRepository
from pipeline.persistence.config import db_config
...
if TYPE_CHECKING:
    ...
    from pipeline.persistence.database import DatabaseController
